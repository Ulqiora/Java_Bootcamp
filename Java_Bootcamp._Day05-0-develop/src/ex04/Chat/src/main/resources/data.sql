...
('Chat 7', (SELECT id FROM chat.user WHERE name = 'Luciano Pavarotti'))
...
((SELECT id FROM chat.user WHERE name = 'Luciano Pavarotti'), (SELECT id FROM chat.chatroom WHERE title = 'Chat 4'), 'Hello, I am Eminem'),
((SELECT id FROM chat.user WHERE name = 'Adele'),    (SELECT id FROM chat.chatroom WHERE title = 'Chat 4'), 'Hello, I am Adele'),
((SELECT id FROM chat.user WHERE name = 'Adele'),    (SELECT id FROM chat.chatroom WHERE title = 'Chat 7'), 'Hello, I am Cardy B'),
