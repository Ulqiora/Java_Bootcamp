...
public class TransactionsService {
    ...
    public TransactionsLinkedList GetInvalidTransactions() {
    ...
    private void CompareTransactionList(int userIndex, Transaction transaction, TransactionsLinkedList ttl){
        for(int i=0;i<usersList.getSize();i++){
